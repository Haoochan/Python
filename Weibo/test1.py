...
# 控制台日志
sys.stdout = Logger("E:\\GitHub\\Python\\text_log_6.txt")
...
def get_data(url):
    ...
    count = []
    getdata_threads = []
    g1 = MyThread(get_data_thread, args=(url, 1, total_pages, 5))
    getdata_threads.append(g1)
    g2 = MyThread(get_data_thread, args=(url, 2, total_pages, 5))
    getdata_threads.append(g2)
    g3 = MyThread(get_data_thread, args=(url, 3, total_pages, 5))
    getdata_threads.append(g3)
    g4 = MyThread(get_data_thread, args=(url, 4, total_pages, 5))
    getdata_threads.append(g4)
    g5 = MyThread(get_data_thread, args=(url, 5, total_pages, 5))
    getdata_threads.append(g5)
    # g6 = MyThread(get_data_thread, args=(url, 6, total_pages, 5))
    # getdata_threads.append(g6)
    # g7 = MyThread(get_data_thread, args=(url, 7, total_pages, 5))
    # getdata_threads.append(g7)
    # g8 = MyThread(get_data_thread, args=(url, 8, total_pages, 5))
    # getdata_threads.append(g8)
    # g9 = MyThread(get_data_thread, args=(url, 9, total_pages, 5))
    # getdata_threads.append(g9)
    # g10 = MyThread(get_data_thread, args=(url, 10, total_pages, 5))
            ...
            while True:
                ...
                if start_time == end_time:
                    ...
                    for hours in range(int(start_hour), -1, -1):
                        weibo_urls = url['page_by_hour'] % {'keyword': keyword, 'start_time': start_time,
...
threads = []
# 2018-2019
# t1 = MyThread(my_function,args=('伊卡璐','2018-09-01-0','2019-01-01-0',))
# threads.append(t1)
