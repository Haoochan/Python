...
# proxies = {"http":"175.148.78.174:1133"}
proxy = [
    '61.135.217.7:80',
...
threads = []
#2018-2019
t1 = threading.Thread(target=my_function,args=('伊卡璐','2018-09-01-0','2019-01-01-0',))
threads.append(t1)
t2 = threading.Thread(target=my_function,args=('伊卡璐','2018-05-01-0','2018-09-01-0',))
threads.append(t2)
t3 = threading.Thread(target=my_function,args=('伊卡璐','2018-01-01-0','2018-05-01-0',))
threads.append(t3)
#2017-2018
t4 = threading.Thread(target=my_function,args=('伊卡璐','2017-09-01-0','2018-01-01-0',))
threads.append(t4)
t5 = threading.Thread(target=my_function,args=('伊卡璐','2017-05-01-0','2017-09-01-0',))
threads.append(t5)
t6 = threading.Thread(target=my_function,args=('伊卡璐','2017-01-01-0','2017-05-01-0',))
threads.append(t6)
#2016-2017
t7 = threading.Thread(target=my_function,args=('伊卡璐','2016-09-01-0','2017-01-01-0',))
threads.append(t7)
t8 = threading.Thread(target=my_function,args=('伊卡璐','2016-05-01-0','2016-09-01-0',))
threads.append(t8)
t9 = threading.Thread(target=my_function,args=('伊卡璐','2016-01-01-0','2016-05-01-0',))
threads.append(t9)
#2015-2016
t10 = threading.Thread(target=my_function,args=('伊卡璐','2015-09-01-0','2016-01-01-0',))
threads.append(t10)
t11 = threading.Thread(target=my_function,args=('伊卡璐','2015-05-01-0','2015-09-01-0',))
threads.append(t11)
t12 = threading.Thread(target=my_function,args=('伊卡璐','2015-01-01-0','2015-05-01-0',))
threads.append(t12)
#2014-2015
t13 = threading.Thread(target=my_function,args=('伊卡璐','2014-09-01-0','2015-01-01-0',))
threads.append(t13)
t14 = threading.Thread(target=my_function,args=('伊卡璐','2014-05-01-0','2014-09-01-0',))
threads.append(t14)
t15 = threading.Thread(target=my_function,args=('伊卡璐','2014-01-01-0','2014-05-01-0',))
threads.append(t15)
#2013-2014
t16 = threading.Thread(target=my_function,args=('伊卡璐','2013-09-01-0','2014-01-01-0',))
threads.append(t16)
t17 = threading.Thread(target=my_function,args=('伊卡璐','2013-05-01-0','2013-09-01-0',))
threads.append(t17)
t18 = threading.Thread(target=my_function,args=('伊卡璐','2013-01-01-0','2013-05-01-0',))
threads.append(t18)
#2012-2013
t19 = threading.Thread(target=my_function,args=('伊卡璐','2012-09-01-0','2013-01-01-0',))
threads.append(t19)
t20 = threading.Thread(target=my_function,args=('伊卡璐','2012-05-01-0','2012-09-01-0',))
threads.append(t20)
t21 = threading.Thread(target=my_function,args=('伊卡璐','2012-01-01-0','2012-05-01-0',))
threads.append(t21)
#2011-2012
t22 = threading.Thread(target=my_function,args=('伊卡璐','2011-09-01-0','2012-01-01-0',))
threads.append(t22)
t23 = threading.Thread(target=my_function,args=('伊卡璐','2011-05-01-0','2011-09-01-0',))
threads.append(t23)
t24 = threading.Thread(target=my_function,args=('伊卡璐','2011-01-01-0','2011-05-01-0',))
threads.append(t24)
#2010-2011
t25 = threading.Thread(target=my_function,args=('伊卡璐','2010-09-01-0','2011-01-01-0',))
threads.append(t25)
t26 = threading.Thread(target=my_function,args=('伊卡璐','2010-05-01-0','2010-09-01-0',))
threads.append(t26)
t27 = threading.Thread(target=my_function,args=('伊卡璐','2010-01-01-0','2010-05-01-0',))
threads.append(t27)
#2009-2010
t28 = threading.Thread(target=my_function,args=('伊卡璐','2009-08-16-0','2010-01-01-0',))
threads.append(t28)
# t1 = threading.Thread(target=my_function,args=('伊卡璐','2018-01-01-0','2019-01-01-0',))
# threads.append(t1)
# t2 = threading.Thread(target=my_function,args=('伊卡璐','2017-01-01-0','2018-01-01-0',))
# threads.append(t2)
# t3 = threading.Thread(target=my_function,args=('伊卡璐','2016-01-01-0','2017-01-01-0',))
# threads.append(t3)
# t4 = threading.Thread(target=my_function,args=('伊卡璐','2015-01-01-0','2016-01-01-0',))
# threads.append(t4)
# t5 = threading.Thread(target=my_function,args=('伊卡璐','2014-01-01-0','2015-01-01-0',))
# threads.append(t5)
# t6 = threading.Thread(target=my_function,args=('伊卡璐','2013-01-01-0','2014-01-01-0',))
# threads.append(t6)
# t7 = threading.Thread(target=my_function,args=('伊卡璐','2012-01-01-0','2013-01-01-0',))
# threads.append(t7)
# t8 = threading.Thread(target=my_function,args=('伊卡璐','2011-01-01-0','2012-01-01-0',))
# threads.append(t8)
# t9 = threading.Thread(target=my_function,args=('伊卡璐','2010-01-01-0','2011-01-01-0',))
# threads.append(t9)
# t10 = threading.Thread(target=my_function,args=('伊卡璐','2009-08-16-0','2010-01-01-0',))
# threads.append(t10)
